package com.kelompok13.reportapps.ui.main;
...
import com.kelompok13.reportapps.ui.history.HistoryActivity;
import com.kelompok13.reportapps.ui.report.ReportActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    CardView cvBarang, cvKeadilan, cvFasilitas, cvHistory;
    ...
    private void setInitLayout() {
        cvBarang = findViewById(R.id.cvBarang);
        cvKeadilan = findViewById(R.id.cvKeadilan);
        cvFasilitas = findViewById(R.id.cvFasilitas);
        cvHistory = findViewById(R.id.cvHistory);

        cvBarang.setOnClickListener(v -> {
            strTitle = "Aduan Barang Hilang";
            Intent intent = new Intent(MainActivity.this, ReportActivity.class);
            intent.putExtra(ReportActivity.DATA_TITLE, strTitle);
            startActivity(intent);
        });

        cvKeadilan.setOnClickListener(v -> {
            strTitle = "Aduan Ketidakadilan";
            Intent intent = new Intent(MainActivity.this, ReportActivity.class);
            intent.putExtra(ReportActivity.DATA_TITLE, strTitle);
            startActivity(intent);
        });

        cvFasilitas.setOnClickListener(v -> {
            strTitle = "Aduan Fasilitas Rusak";
            Intent intent = new Intent(MainActivity.this, ReportActivity.class);
            intent.putExtra(ReportActivity.DATA_TITLE, strTitle);
            startActivity(intent);
        });
