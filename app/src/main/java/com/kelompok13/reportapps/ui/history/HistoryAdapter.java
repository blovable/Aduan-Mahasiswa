package com.kelompok13.reportapps.ui.history;
...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(HistoryAdapter.ViewHolder holder, int position) {
        ...
        switch (data.getKategori()) {
            case "Aduan Kehilangan Barang":
                holder.layoutHeader.setBackgroundResource(R.color.purple_200);
                break;
            case "Aduan Ketidakadilan":
                holder.layoutHeader.setBackgroundResource(R.color.green);
                break;
            case "Aduan Fasilitas Rusak":
